...
# VERSION: 4.8.7 (Filename Variable Resolution Fix)
...
============================================================
v4.8.7 (2026-05)
· Fixed: Updated Section 4 Output Workflow Step 2 with explicit instructions to resolve company, position, and date variables to fix the literal string filename bug introduced in v4.8.4.
...
# GENERATED BY: JOB POSTING INTELLIGENCE ENGINE v4.8.7
