...
# VERSION: 4.8.12 (Isolated Filename Blueprint)
...
============================================================
v4.8.12 (2026-05)
· Fixed: Extracted the suggested filename variable entirely out of the main report container. It now displays as an independent text element prior to block compilation to maximize rendering stability.
· Fixed: Maintained 100% of the v4.8.11 full-featured 19-section functional specification.
...
# GENERATED BY: JOB POSTING INTELLIGENCE ENGINE v4.8.12
...
# 4. OUTPUT WORKFLOW
============================================================
Step 1: Resolve the runtime syntax variables and print the suggested markdown file name as a single, standalone line of regular text:
**Suggested Filename:** `Posting-[RESOLVED_COMPANY]-[RESOLVED_POSITION_NAME]-[CURRENT_YYYYMMDD].md`

Step 2: Open a single, continuous Markdown codeblock container immediately below the filename text.
Step 3: Generate the full report from Section 0 through Section 18 completely within that single codeblock.
Step 4: Close the markdown codeblock container.