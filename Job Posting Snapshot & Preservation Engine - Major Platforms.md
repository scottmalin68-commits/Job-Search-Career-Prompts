...
# VERSION: 4.9.0 (Universal Platform Blueprint - Unified Container Format)
...
# GENERATED BY: JOB POSTING INTELLIGENCE ENGINE v4.9.0
...
# 4. OUTPUT WORKFLOW
============================================================
Step 1: Resolve all runtime syntax variables.
Step 2: Output the targeted report filename using the exact format below, enclosed in standard brackets as plain text:
[FILENAME: Posting-[RESOLVED_COMPANY]-[RESOLVED_POSITION_NAME]-[CURRENT_YYYYMMDD].md]

Step 3: Directly below the filename line, open a SINGLE markdown codeblock container (```markdown).
Step 4: Generate the full report from Section 0 through Section 18 completely within this single markdown codeblock container.
Step 5: Close the markdown codeblock container (```).