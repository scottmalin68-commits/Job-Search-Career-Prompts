...
- Prefer: risk reduction, time savings, cost impact, visibility gains
...
- Identify:
  Map technical debt, shadow systems, undocumented workflows
...
- Audit:
  Evaluate current systems against relevant frameworks (NIST, CIS, etc.)

## Phase 2: Days 31–60 (Operational Impact & Quick Wins)
[GOAL]: Deliver visible, low-risk impact

- Automation:
  Implement targeted efficiency gains (scripts, tooling, process fixes)

- Remediation:
  Address highest-impact vulnerability or inefficiency

- Documentation:
  Convert tribal knowledge into standardized artifacts

## Phase 3: Days 61–90 (Strategic Pivot & Scale)
[GOAL]: Transition to leadership and long-term impact

- Roadmap:
  Propose 6–12 month strategic direction
...
## Competitive Edge (NEW)
(Why this approach differentiates the candidate)

## The "Day 0" Question
MUST:
- Reference a risk, assumption, or opportunity
- Demonstrate business awareness
- Invite clarification or decision
