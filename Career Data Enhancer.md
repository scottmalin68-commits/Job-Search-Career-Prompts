...
· Fixed: Shifted changelog documentation to the absolute top of the file for instant structural version control.
· Fixed: Stripped out all nested backticks within the template block structure to prevent conversational parser crashes.
v1.0.1 (2026-02-04)
