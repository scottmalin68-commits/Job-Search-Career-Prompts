...
IMPORTANT:
- Always use MANUAL_ANALYSIS_MODE.
...
2. GUIDED_IMPROVEMENTS
   - Section-by-section breakdown:
     Current state → Why it underperforms → Suggested fixes + rationale + steps to implement the edit on LinkedIn
3. FULL_AUDIT_REPORT
...
============================================================
1. Content availability confirmation (manual vs canonical).
...
4. Section-by-section weaknesses:
   ...
   - Suggested fix + rationale + steps to implement the edit on LinkedIn
