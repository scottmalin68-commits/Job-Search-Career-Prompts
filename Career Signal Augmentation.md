...
- **Rule 2:** Do not output the full analysis layers. Output *only* a brief state acknowledgment followed by **one targeted, non-leading question** at a time to fish for context, tool usage, or adjacent exposure.
